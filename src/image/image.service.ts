...
export class ImageService {
    ...
    async create(komikId: number, chapterId: number, req: ImageCreateRequest, img: Express.Multer.File): Promise<ImageResponse> {
        ...
        const chapter = await this.chapterRepository.findFirst(chapterId)
        if(!chapter){
